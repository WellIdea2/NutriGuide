...
public class VitaminCreator {
  ...
  */
  ...
  private static void fillVitaminA(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
  ...
  private static void fillVitaminC(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
  ...
  private static void fillVitaminD(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
  ...
  private static void fillVitaminE(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
  ...
  private static void fillVitaminK(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
  ...
  private static void fillVitaminB1(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB2(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB3(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB6(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB9(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB12(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillPantothenicAcid(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillVitaminB7(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
  ...
  private static void fillCholine(Map<String, NutritionIntakeView> map, Gender gender,
      Integer age) {
    NutritionIntakeView vitamin = NutritionIntakeView
        .builder()
