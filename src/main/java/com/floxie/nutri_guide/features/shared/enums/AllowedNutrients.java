package com.floxie.nutri_guide.features.shared.enums;
...
public enum AllowedNutrients {
  ...
  public static boolean isValidNutrition(String name, String unit) {
    return Arrays.stream(values())
        .anyMatch(nutrient ->
            nutrient.getNutrientName().equals(name) &&
                nutrient.getNutrientUnit().equals(unit)
        );
  }
}